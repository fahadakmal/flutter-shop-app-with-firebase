...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    _slightAnimation = Tween<Offset>(
        begin: Offset(0,1.5), end: Offset(0,0)).animate(CurvedAnimation(parent: _controller,curve: Curves.linear ));
  ...
  Future<void> _submit() async {
    ...
    try {
      if (_authMode == AuthMode.Login) {
        ...
        // Sign user up
        await Provider.of<Auth>(context, listen: false)
            .siginup(_authData['email'], _authData['password']);
      }
